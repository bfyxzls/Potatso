...
class ConfigGroupChooseWindow: UIWindow {
    ...
    override init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ConfigGroupChooseWindow.onStatusBarFrameChange), name: NSNotification.Name.UIApplication.didChangeStatusBarFrameNotification, object: nil)
    }
